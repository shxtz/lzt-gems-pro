...
import { Search, ShoppingCart, Tag, Zap, Package, Filter } from "lucide-react";
...
const Shop = () => {
  ...
  const { data: stockCounts } = useQuery({
    ...
    queryFn: async () => {
      // We can't query stock directly (RLS), so we'll use a workaround
      // For now, we show variations and handle "out of stock" on purchase
      return {};
    },
  });
      ...
      <div className="pt-20 pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-8 md:py-12">
            ...
            >
              Contas e keys com entrega automática
            </motion.p>
                  ...
                  >
                    ...
                    <div className="aspect-video bg-muted/20 relative overflow-hidden">
                      ...
                      <div className="absolute top-3 right-3">
                        <Badge variant="outline" className="bg-background/80 backdrop-blur-sm text-[10px] border-green-500/30 text-green-500">
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  <Badge variant="outline" className="text-[10px]">
                                    {v.credential_type === "key" ? "🔑 Key" : "📧 Conta"}
                                  </Badge>
