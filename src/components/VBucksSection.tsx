            ...
            {!showContact ? (
              ...
              >
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-1 sm:gap-1.5 rounded-xl bg-[#5865F2] py-2.5 sm:py-3 font-display text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.1em] sm:tracking-[0.15em] text-white hover:bg-[#4752C4] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                   className="flex items-center justify-center rounded-xl bg-[#25D366]/20 border border-[#25D366]/30 py-2.5 sm:py-3 px-2.5 sm:px-3 hover:bg-[#25D366]/30 transition-colors"
                 >
